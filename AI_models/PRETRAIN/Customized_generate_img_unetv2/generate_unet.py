...
def resblock_con2d(init, skip, filters):
    skip_ =  Conv2D(filters, kernel_size = (1, 1), strides=(1, 1), use_bias=False,
                kernel_initializer='he_normal', data_format=IMAGE_ORDERING)(skip)
    x = Add()([init, skip_])
    return x
...
def UNET_v2( nClasses, input_height, input_width, n_filters=16*4, dropout=0.1,
    ...
    #p2 = convolutions(c2, filters=128)
    ...
    #p3 = convolutions(c3, filters=256)
    ...
    #p4 = convolutions(c4, filters=512)
