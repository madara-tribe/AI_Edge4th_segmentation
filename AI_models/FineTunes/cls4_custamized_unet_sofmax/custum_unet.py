...
def convolutions(c, filters):
    return Conv2D(filters = filters, kernel_size = (2, 2), strides=(2, 2),
               kernel_initializer = 'he_normal', padding = 'same', data_format=IMAGE_ORDERING)(c)
