...
def image_segmentation_generator(images_path, segs_path, batch_size,
                                 n_classes=11, input_height=224, input_width=224,
                                 output_height=224, output_width=224,
                                 do_augment=False,
                                 augmentation_name="aug_all"):
    train_images = os.listdir(images_path)
    train_images.sort()
    train_segmentations  = os.listdir(segs_path)
    train_segmentations.sort()
    img_seg_pairs = get_pairs_from_paths(train_images, train_segmentations)
