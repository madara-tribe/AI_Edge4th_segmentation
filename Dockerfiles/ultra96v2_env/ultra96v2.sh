...
cp ultra96v2_oob_xsa.tcl4.bak ultra96v2_oob_xsa.tcl
rm *.bak
...
cat rootfs_config5.bak | sed -e 's/# CONFIG_packagegroup-petalinux-weston is not set/CONFIG_packagegroup-petalinux-weston=y/g' -e 's/# CONFIG_ffmpeg is not set/CONFIG_ffmpeg=y/g' > rootfs_config6.bak
...
cat user_2019-10-31-20-33-00.cfg.bak | sed -e 's/CONFIG_CMA_SIZE_MBYTES=1024/CONFIG_CMA_SIZE_MBYTES=512/g' | sed -e '$aCONFIG_CMA_DEBUG=y' > user_2019-10-31-20-33-00.cfg
cd ../../../../..
# path ==> ultra96v2_oob/petalinux
